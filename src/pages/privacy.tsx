...
const SafePrivacyPolicy = () => (
  <SmoothScroll>
    ...
    <p>
      In addition, we may take a recording of you while testing {'Mantle Safe'} for internal and external use. The
    ...
    <p>
      We enable the user to unlock the {'Mantle Safe'} mobile app via biometrics information (touch ID or face ID).
    ...
    <p>
      ...
      different decentralized applications and our app and to enhance your experience with {`Mantle Safe`}. For

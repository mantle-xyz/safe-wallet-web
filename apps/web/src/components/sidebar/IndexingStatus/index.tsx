...
const STATUS_PAGE = IS_PRODUCTION
  ? 'https://tx-status-app.safe.protofire.io/?serviceUrl=https://gateway.multisig.mantle.xyz'
  : 'https://tx-status-app.safe.protofire.io/?serviceUrl=https://gateway.staging.multisig.mantle.xyz'
